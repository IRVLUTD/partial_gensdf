...
def create_mesh(
    ...
    convert_sdf_samples_to_ply(
        sdf_values.data, voxel_origin, voxel_size, ply_filename + ".ply", level_set
    )
...
def convert_sdf_samples_to_ply(
    ...
    verts_o3d = o3d.utility.Vector3dVector(mesh_points)
    faces_o3d = o3d.utility.Vector3iVector(faces)
    mesh_o3d = o3d.geometry.TriangleMesh(verts_o3d, faces_o3d)
    mesh_o3d.compute_vertex_normals()
    o3d.io.write_triangle_mesh(ply_filename_out, mesh_o3d)
